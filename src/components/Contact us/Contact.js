...
const Contact = () => {
    ...
    <div className='contact'>
        ...
        <div className='customize-Contact'>
          <div className="customize-box">
            <h2 className={'fs_40 text-white fw_700 mb_20 pt_74'}>Contact Us</h2>
                          </div>
                          </div>
            </div>
  ...
  <a href="#" className='pr_10 '>
    <img className="img-fluid icon-coffee" src={location} alt="Location" />
  </a>
  <span>
    ...
    New Palmas South Carolina.
              ...
              <li className='pt_38'><a href="#" className='pr_10'>
                          <img className={'img-fluid'} src={phone} alt=""/>
                        </a>+1 234 678 9108 99</li>
              <li className='pt_38'><a href="#" className='pr_10'>
                          <img className={'img-fluid'} src={email} alt=""/>
                        </a>Contact@moralizer.com</li>
            </ul>
                      </div>
          ...
          {/* Right Column */}
                  <div className="customize-your-form col-md-8">
                      <div className='customize-right-col'>
                          <form className='customize-form pt_68'>
                            ...
                            <div className="customize-form-row row pb_38">
                                ...
                                <input type="email" className="form-control" placeholder='jimepib332@ofacer.com' />
                                </div>
                                <div className="customize-form-filed col">
                                <label className='pb_8 fs_20'>Phone number</label>
                                <input type="text" className="form-control" placeholder='+1 012 3456 789' />
                                </div>
                                            </div>
                                            
<div className="customize-your-texture mb-3">
  <label className="fw-bold fs-5 d-block mb-2 pb_28">Choose Grinding Texture</label>

                       <div className="form-check form-check-inline">
                                  <label className="form-check-label fs-6" htmlFor="texture2">General Inquiry</label>
    <input className="form-check-input" type="radio" name="texture" id="texture2" />
    ...
    <input className="form-check-input" type="radio" name="texture" id="texture2" />
              ...
              <div className="customize-your-textarea mb-3">
                ...
                <textarea className="form-control fs_14" rows="4" placeholder="Write your message." />
              </div>
