  ...
  return (
    <div>
      <section className="news-section">
        <h1 className="mb_30 fw_700">Discover Our latest News</h1>
        <div className="news-container">
          ...
          <div className="main-news ">
            ...
            <div className="main-news-content pt_26  fw_600">
              <h3 className=" fw_600">Artificial Intelligence</h3>
              <h2 className="main-news-para fw_700 pt_30">
                Harnessing Artificial Intelligence to Revolutionize Workflow
                Automation and Drive Smarter Business Decisions
              </h2>
              <p className="pt_30  pb_30">Olivia Thompson • Aug 10, 2025</p>
            </div>
          </div>
          {/* Right Side News */}
          <div className="side-news">
            <div className="news-card">
              ...
              <div className="news-card-content">
                <h5 className="pt_14">Cloud Computing</h5>
                <h4 className=" pt_40">
                  Cloud Transformation Roadmap: How Businesses Can Achieve
                  <br />
            ...
            <div className="news-card">
              ...
              <div className="news-card-content">
                <h5 className=" pt_14 ">Cybersecurity</h5>
                <h4 className=" pt_24">
            ...
            <div className="news-card">
              ...
              <div className="news-card-content">
                <h5 className="pt_14 ">Web Development</h5>
                <h4 className="pt_24">
          ...
          <div className="grid pt_50">
            ...
            <div className="card ">
              ...
              <div className="card-details">
                <p className="category pt_24 fw_600 pr-7  pb_30 ">
                  Data Analytics
                </p>
                <h3 className="card_desc pb_30">
            ...
            <div className="card">
              ...
              <div className="card-details">
                <p className="category  pt_24 pr-7 fw_600 pb_30">IT Strategy</p>
                <h3 className="card_desc pb_30">
                  Future–Proofing Your Business IT Infrastructure to Thrive in
            ...
            <div className="card">
              ...
              <div className="card-details">
                <p className="category  pt_24 pr-7  fw_600 pb_30">
                  Cybersecurity
                </p>
                <h3 className="card_desc pb_30">
