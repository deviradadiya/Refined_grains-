    ...
    <>
      <nav className="navbar navbar-expand-lg p-0 position-fixed w-100 z-3">
        <div className="container">
          <div className="nav-background d-flex justify-content-between align-items-center w-100">
            {/* Left Logo + Toggler */}
                ...
                {HeaderMenu.map((item, idx) => (
                  <li className="nav-item" key={idx}>
                    <NavLink
                      to={item.path}
                      className="nav-link"
                      onClick={handleClose} // 👉 link click par close
                    >
                      {item.name}
                    </NavLink>
                  </li>
              ...
              <div className="login-body">
                ...
                <div className="mobile-input-wrapper d-flex align-items-center">
                  <div className="country-code-box mr_32">
                    <span className="fw-bold fs_20 fw_600 pb_10 d-block">
                      +91
                    </span>
                  </div>
                  <input
